...
class MaistoIslaidosd05508c30(Bolt):
    # Important : Define output field tags for the Bolt
    outputs = ["MaistoIslaidos_d05508c3-0549-499d-bc01-7c25fd2b3e95"]
    ...
    def process(self, tup):
        ...
        if True:
            ...
            if not({'SuvalgytasMaistas_d05508c3-0549-499d-bc02-7c25fd2b3e95', 'IsmestasMaistas_d05508c3-0549-499d-bc01-7c25fd2b3e85'} <= set(self.temp_combination[input_dict['unique_id']])):
                return
            else:
                output_dict['result'] = self.temp_combination[input_dict['unique_id']]
                self.temp_combination.pop(input_dict['unique_id'])
            
        input_value = (output_dict['result']['SuvalgytasMaistas_d05508c3-0549-499d-bc02-7c25fd2b3e95']['last_value'] * 0.9) + output_dict['result']['IsmestasMaistas_d05508c3-0549-499d-bc01-7c25fd2b3e85']['last_value']
