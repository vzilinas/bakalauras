...
if __name__ == '__main__':
    ...
    maistoislaidosd05508c30_bolt = builder.add_bolt('maistoislaidosd05508c30', MaistoIslaidosd05508c30, par=5, inputs = {suvalgytasmaistasd05508c_bolt : Grouping.fields('unique_id'), loterijoslaimejimaid0550_bolt : Grouping.fields('unique_id'), ismestasmaistasd05508c3_bolt : Grouping.fields('unique_id')})
    islaidosd15508c3054849_bolt = builder.add_bolt('islaidosd15508c3054849', Islaidosd15508c3054849, par=5, inputs = {maistoislaidosd05508c30_bolt : Grouping.fields('unique_id')})


    emitter_bolt = builder.add_bolt("emitter_bolt", EmitterBolt, par=10,
                                    inputs={uzdarbis416f51b52b8a4c_bolt : Grouping.SHUFFLE, atlyginimasc5df16a0679a_bolt : Grouping.SHUFFLE, atostoginiai49e661dd1d6_bolt : Grouping.SHUFFLE, islaidosd15508c3054849_bolt : Grouping.SHUFFLE, maistoislaidosd05508c30_bolt : Grouping.SHUFFLE, suvalgytasmaistasd05508c_bolt : Grouping.SHUFFLE, loterijoslaimejimaid0550_bolt : Grouping.SHUFFLE, ismestasmaistasd05508c3_bolt : Grouping.SHUFFLE})
