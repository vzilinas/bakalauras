...
class PizzaFridayExpense117af4(Bolt, StatefulComponent):
    # Important : Define output field tags for the Bolt
    outputs = ["PizzaFridayExpense_117af450-3086-412f-90f5-ad63e1989d04", "unique_id"]
    ...
    def initialize(self, config, context):
        ...
        self.log("Initializing PizzaFridayExpense117af4...")
        self.results = {
    ...
    def process(self, tup):
        ...
        input_value = input_dict['data']['PizzaFridayExpense']
        if output_dict['unique_id'] in self.temp_combination:
        ...
        output_dict['result']['PizzaFridayExpense117af4'] = result
        self.emit([pickle.dumps(output_dict), output_dict['unique_id']])
        self.redis_db.sadd('departament-expenditure-indicator:PizzaFridayExpense117af4:state_values', output_dict['primary_key'])
        self.redis_db.set('departament-expenditure-indicator:PizzaFridayExpense117af4:' + output_dict['primary_key'], msgpack.packb(self.results[output_dict['primary_key']]))
