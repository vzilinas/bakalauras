...
Numatomas tyrimo metodas: eksperimentas, kurio metu bus aprašytos duomenų struktūros ir duomenų pokyčių aprašymai, padaryta neišsami interneto straipsnių ir srautinio apdorojimo sistemų dokumentacijų analizė srautinio apdorojimo sistemai pasirinkti, sukurtas srautinio apdorojimo modulių generatorius (remiantis knyga: Code Generation in Action parašyta Jack Herrington) ir aprašyti sprendimo generuojamą kodą. \par 
