...
Kodo generavimo komponentas - pagrindinis architektūros komponentas reikalaujantis daugiausiai darbo. Pagrindiniai šio komponento reikalavimai:
\begin{itemize}
    \item Taškas (angl. endpoint) rodiklių duomenų modelio pateikimui.
    \item Srautinio apdorojimo sistemų generavimas pagal pateiktą rodiklių duomenų modelį.
