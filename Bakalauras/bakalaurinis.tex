...
Taip pat tarkime, kad po laiko buvo nuspręsta taip pat apdoroti kondensacijos taško \cite{wanielista1997hydrology} rodiklį: 
\[\textit{Kondensacijos taškas} = ((\textit{Drėgmė} / 100)^{\frac{1}{8}})*(112+(0.9*\textit{Temperatūra}))+0.1*\textit{Temperatūra}-112\]
