...
\begin{itemize}
    ...
    \item Skaičiavimo "Bolt" tipo komponentas saugantis pasikartojančių žodžių žodyną, kur raktas - žodis, o reikšmė - kiek kartų pasikartojo. Gavęs žodi jis padidina jo skaitiklį žodine ir perduoda į kitą žinučių eilę.
\end{itemize}
\begin{figure}[H]
    \centering
