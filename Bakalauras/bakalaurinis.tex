...
Rodiklių duomenis yra gaunami apdorojus pirminių rodiklių duomenis, kurie susidaro iš raktų ir reikšmių žodyno (\ref{img:duomenys} pav.), kur raktas gali būti tik tekstinio tipo, o reikšmė - tekstas arba skaičius. Duomenų raktai ir raktų kiekis gali nesutapti, vieni žodynai gali turėti daugiau raktų-reikšmių elementų, kitų raktai gali būti visiškai nesusiję su apdorojamais rodikliais. \par 
...
\begin{table}[!htbp]
    \begin{center}
        ...
        \begin{tabular}{ | l | l |}
            ...
            \cellcolor[gray]{0.9} Pristatymas & test \\* \hline
            \cellcolor[gray]{0.9} Uždelstumas & test \\* \hline
            \cellcolor[gray]{0.9} Pralaidumas & test \\* \hline
            \cellcolor[gray]{0.9} Abstrakcijos lygis & test \\* \hline
        \end{tabular}
    \end{center}
\end{table}\par
...
Norint patikrinti siūlomą architektūrą buvo sukurtas sprendimas su kuriuo bus daromi bandymai.
...
Generavimas vykdomas pagal šabloną, buvo sukurti specialus šablonai, kiekvienam srautinio apdorojimo sprendimo komponento tipui. Šablonuose laukai kuriuos reikia pakeisti užrašyti specialiais identifikuojančiais elementais. Generavimo metų šie elementai pakeičiami pagal duomenis kurie apdorojami.
...
Pilnam sistemos veikimui taip pat reikia papildomos programinės įrangos, kurį užsiima duomenų perdavimu, kompiliavimu. Ši įranga naudojama tokia kaip pateikiama nekeičiant konfigūracijos iš esmės.
\begin{itemize}
